...
function formSubmit(){
	...
	if(chkRetAmount && chkRetOrderdate && chkRetMerchandise && chkRetClient && chkRetEmployee ){
		chk = true;
	}
	return chk;
}
...
<body>
<p></p>
<p><font style="font-size: 10pt;">销售管理->订货单->修改</font></p>
<s:form action="stockorderAction" method="post" theme="simple"
	onsubmit="return formSubmit();">
	<s:hidden name="stockorder.id" />
	<p></p>
	<table border="0" cellpadding="1" cellspacing="1" width="95%">
		<tr>
			<td align="right" width="10%">订货单编号</td>
			<td width="20%"><s:textfield name="stockorder.code"
				disabled="true" /></td>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="95%">
		<tr>
			<td width="10%"><s:submit value="保存" method="updateStockorder" /></td>
